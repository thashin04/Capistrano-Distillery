      ...
      <div className="w-screen"> 
        <div className="flex flex-col lg:flex-row lg:justify-center pt-12 pb-12 items-center lg:w-full mx-auto mt-8 gap-12">
          <div className="text-[#E0C9AC] lg:px-12 sm:px-8 space-y-8 flex flex-col items-center lg:items-start pt-0">
            <h1 className="lg:pb-2 gabarito-header text-center md:text-left lg:text-left text-5xl font-bold 2xl:text-6xl max-sm:text-4xl">LOCATION</h1>
          ...
          {/* google map section */}
          <div className="rounded-3xl overflow-hidden relative max-sm:w-7/12 w-5/12 md:w-4/12 lg:order-last">
            <iframe
